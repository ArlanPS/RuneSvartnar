...
//#exec AUDIO IMPORT FILE=Sounds\SkelemancerSoulFX.wav NAME=SkelemancerSoulFX GROUP="SkelemancerSoul"
// exec AUDIO IMPORT NAME=SkelemancerSoulFX FILE=Sounds\SkelemancerSoulFX.wav GROUP="SkelemancerSoul"
// exec TEXTURE IMPORT NAME=SkelemancerSoul FILE=Textures\SkelemancerSoul.bmp GROUP="SkelemancerSoul" MIPS=OFF FLAGS=2


// #exec TEXTURE IMPORT NAME=newtexture1 FILE=Textures\newtexture1.pcx GROUP=Skins
// #exec TEXTURE IMPORT NAME=newtexture2 FILE=Textures\newtexture2.pcx GROUP=Skins
// #exec TEXTURE IMPORT NAME=newtexture3 FILE=Textures\newtexture3.pcx GROUP=Skins
// #exec TEXTURE IMPORT NAME=newtexture4 FILE=Textures\newtexture4.pcx GROUP=Skins
// #exec TEXTURE IMPORT NAME=newtexture5 FILE=Textures\newtexture5.pcx GROUP=Skins
...
{
	PlayAnim('cine_newtalkC', 1.0, DEFAULT_TWEEN);
	Spawn(class'Goblin',,, l,);
}
